...
Pour la validation l'Obj 4 :
	>> Les testes mené sont semblable à l'Obj 2 et l'Obj 3.
//////////////TEST//////////////////////	
...
au code.
De plus grâce à la fenêtre Logic Analyzer, on peut confirmer la réception du tir par l'un des joueurs.
...
Logic Analyzer : Les configuration sont identiques à l'Obj 3.
Vous devez constater l'apparition du spectre du son dans la fenêtre au moment ou l'un des compteurs d'occurences passe la valeur limite de 3.
